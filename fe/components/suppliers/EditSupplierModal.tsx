...
interface EditSupplierModalProps {
  ...
  onSubmit: (id: string, supplier: Partial<SupplierType>) => Promise<void>;
}

export default function EditSupplierModal({ isOpen, onClose, supplier, onSubmit }: EditSupplierModalProps) {
