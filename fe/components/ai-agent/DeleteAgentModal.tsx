...
import { deleteAIAgent } from '@/services/aiAgentService';
...
export default function DeleteAgentModal({ isOpen, onClose, onSuccess, agent }: DeleteAgentModalProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      setLoading(true);
      const result = await deleteAIAgent(agent.id);
      ...
      toast.error('Gagal menghapus AI Agent');
    } finally {
      setLoading(false);
    }
  };
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mb-6">
                  ...
                  {/* <p className="text-sm text-red-600 mt-4 font-medium">
                    ⚠️ Semua data dan konfigurasi agent ini akan dihapus secara permanen.
                  </p> */}
                </div>
